...
export const BEHAVIOR_SCENARIOS: BehaviorScenario[] = [
  ...
  },
  {
    id: "go-app-run-tests",
    fixture: "go-app",
    task: "Run the Go module test suite before shipping a change.",
    preferredModule: "",
    preferredTestCommand: "go test ./...",
    requiredSurfaces: ["constitution", "standards"],
  },
  {
    id: "rust-cargo-run-tests",
    fixture: "rust-cargo",
    task: "Change Rust library code under src and run the test suite.",
    preferredModule: "src",
    preferredTestCommand: "cargo test",
    requiredSurfaces: ["constitution", "standards", "map", "architect"],
  },
  {
    id: "java-maven-run-tests",
    fixture: "java-maven",
    task: "Run the Maven test suite for the Java application.",
    preferredModule: "",
    preferredTestCommand: "mvn test",
    requiredSurfaces: ["constitution", "standards"],
  },
  {
    id: "kotlin-gradle-run-tests",
    fixture: "kotlin-gradle",
    task: "Run Gradle tests locally with the wrapper script.",
    preferredModule: "",
    preferredTestCommand: "./gradlew test",
    requiredSurfaces: ["constitution", "standards"],
  },
  {
    id: "ruby-rails-run-tests",
    fixture: "ruby-rails",
    task: "Run the Rails RSpec suite before merging.",
    preferredModule: "",
    preferredTestCommand: "bundle exec rspec",
    requiredSurfaces: ["constitution", "standards"],
  },
  {
    id: "dotnet-app-run-tests",
    fixture: "dotnet-app",
    task: "Run the .NET test suite for the application.",
    preferredModule: "",
    preferredTestCommand: "dotnet test",
    requiredSurfaces: ["constitution", "standards"],
  },
];
